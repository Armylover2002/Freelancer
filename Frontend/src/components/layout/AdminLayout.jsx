  ...
  return (
    <div className="flex h-full flex-col">
      <div className="px-5 py-6">
        <p className="text-lg font-extrabold text-white">Agency Admin</p>
        <p className="mt-0.5 text-xs text-white/40">Content & lead management</p>
      </div>
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition ${
                        isActive ? 'bg-accent-500 text-white' : 'text-white/60 hover:bg-white/5 hover:text-white'
                      }`
                    }
                  >
    ...
    <div className="flex min-h-screen bg-surface-muted">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-64 bg-ink-950">
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-ink-900/8 bg-white px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-full border border-ink-900/10 px-3 py-2 text-sm font-medium text-ink-900/70 transition hover:bg-ink-900/5"
            >
